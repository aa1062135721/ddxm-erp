        ...
        <div class="container">
            <div class="search-div">
                <div style="display:flex;">
                   <span style="padding-top:4px">输入搜索：</span>
                ...
                <div class="goodsBox">
                    ...
                    <el-table
                        ...
                        label="相关"
                        width="120"
                        prop="goods_num comment_number">
                        <template slot-scope="scope">
                            <span style="margin-right:10px">商品:<span style="color:#1ABC9C">{{scope.row.goods_num}}</span></span>
                            
                            <span>评论:<span style="color:#1ABC9C">{{scope.row.comment_number}}</span></span>
                        </template>
                        </el-table-column>
                        <el-table-column
                        width="130"
