                        ...
                        <el-card class="box-card" >
                            ...
                            <div class="kucun_info">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr v-for="(item,index) in sukinfo" :key="index">
                                                <td>
                                                    <el-input style="width:130px;" disabled :value="item.bar_code"></el-input>
                                                </td>
                                                <td>{{item.key_name}}</td>
                                                <td>
                                                    <el-input style="width:80px;" v-model="recommendedPrice" :value="item.recommendprice"></el-input>
                                                </td>
                                                <td>
                                                    <el-input style="width:80px;" v-model="salesPrice" :value="item.price"></el-input>
                                                </td>
                                                <td>
                                                    <el-input style="width:80px;" disabled :value="item.stock"></el-input>
                                                </td>
                                                <td>
                                                    <el-input style="width:80px;" v-model="warning" :value="item.warning_value" ></el-input>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                             ...
                             <div class="confirm">
                                ...
                                <el-button @click="modify_goods" style="background:#1ABC9C; color:#fff">确定</el-button>                                 
                            </div>   
                        </el-card>
                    </div>
                    <div class="footer" >
