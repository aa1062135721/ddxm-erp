    ...
    <div class="classification">
        <div class="container">
            <div class="search-div">
                <div class="goodsBox">
                    <div class="mTitle">
                        <span style="color:#666;">数据列表
                            <span
                                @click="returnNext"
                                v-if="flag"
                                style="color:#444; font-size:14px; margin-left:30px"
                            >返回>></span>
                        </span>
                        <div>
                    ...
                    >
                        ...
                        <el-table-column label="分类名称" width="120" prop="gc_name"></el-table-column>
                        <el-table-column label="级别" prop="gc_level"></el-table-column>
                        <el-table-column label="商品数量" width="200" prop="goods_num"></el-table-column>
                        ...
                        <el-table-column label="排序" width="120" prop="gc_sort"></el-table-column>
                        <el-table-column label="设置" prop="sales" width="260">
                            <template slot-scope="scope">
                                <div class="sorting">
