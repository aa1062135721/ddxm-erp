            ...
            <div class="section">
                <div class="choose_class">
                    ...
                    <div class="middle_class">
                        <ul>
                            <p>选择二级分类</p>
                            <li @click="twoClass(item)" v-for="(item,index) in secondClass" :key="index">{{item.gc_name}}</li>
                        </ul>
                    </div>
                    <img src="../../../../../assets/img/arrow.png">
                    <div class="right_class">
                        <ul>
                            <p>选择三级分类</p>
                            <li @click="threeClass(item)" v-for="(item,index) in thirdClass" :key="index" v-if="item.gc_name">{{item.gc_name}}</li>
                            <p v-else>暂无分类</p>
                        </ul>
                    </div>
                </div>
