<template>
    <div>
        ...
        <div class="container">
            <div>
                <el-button type="primary" plain @click="addDepartmentDialog.visible = true">添加</el-button>
            </div>
            <div>
                <el-table
                    :data="tableData"
        ...
        <el-dialog v-dialogDrag title="添加部门" center :visible.sync="addDepartmentDialog.visible" width="30%">
            <el-form :model="addDepartmentDialog.ruleForm" :rules="addDepartmentDialog.rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                <el-form-item label="部门名称" prop="name">
                    <el-input v-model="addDepartmentDialog.ruleForm.name"></el-input>
                </el-form-item>
                <el-form-item label="职能描述" prop="desc">
                    <el-input type="textarea" v-model="addDepartmentDialog.ruleForm.desc"></el-input>
                </el-form-item>
                <el-form-item>
